...
Source Database       : ua_pim_server

Target Server Type    : MYSQL
Target Server Version : 50640
File Encoding         : 65001

Date: 2018-07-16 16:02:46
*/
...
-- Records of admin
-- ----------------------------
INSERT INTO `admin` VALUES ('1', 'super', 'super@admin.com', '', 'administrator', '10', 'gKkLFMdB2pvIXOFNpF_Aeemvdf1j0YUM', '$2y$13$RNrJ7GK1A5iZRxBpho6sbeCJKfNRxzy5axCeRjZLqvA5W6RuVYBRW', '5vLaPpUS-I-XxJaoGP-GZDk474WdnaK3_1469073015', '1531720666', '127.0.0.1', '湖南省,岳阳市,岳阳县', '1531475871', '1', '1531720666', '1');
INSERT INTO `admin` VALUES ('2', 'admin', 'admin@admin.com', '', 'admin', '10', 'tArp_Kv4z1JlzBUZYCL33N24AZL-_77p', '$2y$13$RNrJ7GK1A5iZRxBpho6sbeCJKfNRxzy5axCeRjZLqvA5W6RuVYBRW', 'CgScbf1E96N3pqH01b0mVi_Z58j8QsRV_1501916190', '1531476557', '127.0.0.1', '湖南省,岳阳市,岳阳县', '1531475871', '1', '1531476557', '2');
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='管理员信息表';

-- ----------------------------
-- Records of admin_log
-- ----------------------------
INSERT INTO `admin_log` VALUES ('1', '2', 'admin', 'update', '/admin/update', 'id=2', '{\"id\":\"2\",\"username\":\"admin\",\"password\":\"\",\"repassword\":\"\",\"face\":\"\",\"email\":\"admin@admin.com\",\"role\":\"admin\",\"status\":\"10\"}', '1531476537', '1');
INSERT INTO `admin_log` VALUES ('2', '1', 'menu', 'create', '/menu/create', 'id=16', '{\"id\":\"\",\"pid\":\"0\",\"menu_name\":\"系统配置\",\"icons\":\"\",\"url\":\"\",\"status\":\"1\",\"sort\":\"200\"}', '1531720501', '1');
INSERT INTO `admin_log` VALUES ('3', '2', 'menu', 'update', '/menu/update', 'id=16', '{\"id\":\"16\",\"pid\":\"0\",\"menu_name\":\"系统配置\",\"icons\":\"menu-icon fa fa-cog\",\"url\":\"\",\"status\":\"1\",\"sort\":\"200\"}', '1531720537', '1');
INSERT INTO `admin_log` VALUES ('4', '1', 'menu', 'create', '/menu/create', 'id=17', '{\"id\":\"\",\"pid\":\"0\",\"menu_name\":\"系统配置\",\"icons\":\"\",\"url\":\"/system-config\",\"status\":\"1\",\"sort\":\"100\"}', '1531720609', '1');
INSERT INTO `admin_log` VALUES ('5', '2', 'menu', 'update', '/menu/update', 'id=17', '{\"id\":\"17\",\"pid\":\"0\",\"menu_name\":\"系统配置\",\"icons\":\"\",\"url\":\"system-config\",\"status\":\"1\",\"sort\":\"100\"}', '1531720619', '1');
INSERT INTO `admin_log` VALUES ('6', '2', 'menu', 'update', '/menu/update', 'id=17', '{\"id\":\"17\",\"pid\":\"0\",\"menu_name\":\"系统配置\",\"icons\":\"\",\"url\":\"system-config/index\",\"status\":\"1\",\"sort\":\"100\"}', '1531720630', '1');
INSERT INTO `admin_log` VALUES ('7', '2', 'menu', 'update', '/menu/update', 'id=17', '{\"id\":\"17\",\"pid\":\"16\",\"menu_name\":\"系统配置\",\"icons\":\"\",\"url\":\"system-config/index\",\"status\":\"1\",\"sort\":\"100\"}', '1531720689', '1');
INSERT INTO `admin_log` VALUES ('8', '2', 'system-config', 'update', '/system-config/update', 'id=1', '{\"id\":\"1\",\"config_key\":\"jingdong/auth_url\",\"config_value\":\"https://oauth.jd.com/oauth/authorize\",\"comment\":\"京东授权地址\"}', '1531726140', '1');
INSERT INTO `admin_log` VALUES ('9', '2', 'system-config', 'update', '/system-config/update', 'id=2', '{\"id\":\"2\",\"config_key\":\"jingdong/app_key\",\"config_value\":\"84FC1EA413556FB66F229EFA075FCCF5\",\"comment\":\"授权appKey\"}', '1531727892', '1');
INSERT INTO `admin_log` VALUES ('10', '2', 'system-config', 'update', '/system-config/update', 'id=2', '{\"id\":\"2\",\"config_key\":\"jingdong/app_key\",\"config_value\":\"84FC1EA413556FB66F299EFA075FCCF5\",\"comment\":\"授权appKey\"}', '1531727976', '1');
...
CREATE TABLE `app_auth` (
  ...
  `app_type` tinyint(4) DEFAULT '2' COMMENT '类型 1京东 2PIM',
  `app_name` varchar(16) NOT NULL DEFAULT '' COMMENT '应用名称',
  `auth_ip` char(15) NOT NULL DEFAULT '0.0.0.0' COMMENT '授权IP',
  `app_id` char(35) NOT NULL DEFAULT '',
  `app_key` char(35) NOT NULL DEFAULT '' COMMENT '秘钥 或 京东的refresh token',
  `token` char(35) NOT NULL DEFAULT '' COMMENT 'token',
  `created_at` int(10) unsigned DEFAULT '0' COMMENT '创建时间',
  `updated_at` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `expire_at` int(10) unsigned DEFAULT '0' COMMENT 'token过期时间',
  `status` tinyint(4) DEFAULT '2' COMMENT '状态 1禁用 2测试(不验证ip) 3启用',
  PRIMARY KEY (`id`),
  UNIQUE KEY `app_name` (`app_name`),
  UNIQUE KEY `auth_ip` (`auth_ip`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of app_auth
-- ----------------------------
INSERT INTO `app_auth` VALUES ('1', '2', '京东授权', '0.0.0.0', 'jingdong', '', '', '0', '0', '0', '3');
...
-- ----------------------------
INSERT INTO `auth_assignment` VALUES ('admin', '2', '1531475934');
INSERT INTO `auth_assignment` VALUES ('administrator', '1', '1531475934');
...
-- ----------------------------
INSERT INTO `auth_item` VALUES ('admin', '1', '管理员', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin-log/delete', '2', '操作日志-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin-log/delete-all', '2', '操作日志-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin-log/export', '2', '操作日志-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin-log/index', '2', '操作日志-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin-log/search', '2', '操作日志-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/address', '2', '管理员信息信息-查询地址', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/create', '2', '管理员信息-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/delete', '2', '管理员信息-删除数据', 'admin-delete', null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/delete-all', '2', '管理员信息-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/editable', '2', '管理员信息-行内编辑', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/export', '2', '管理员信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/index', '2', '管理员信息-显示数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/search', '2', '管理员信息-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/update', '2', '管理员信息-修改数据', 'admin', null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/upload', '2', '管理员信息-上传头像', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('admin/view', '2', '管理员信息-显示详情', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('administrator', '1', '超级管理员', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/arrange', '2', '我的日程-查询数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/calendar', '2', '我的日程-查看详情', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/create', '2', '日程管理-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/delete', '2', '日程管理-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/delete-all', '2', '日程信息-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/editable', '2', '日程管理-行内编辑', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/export', '2', '日程信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/index', '2', '日程管理-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/search', '2', '日程管理-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('arrange/update', '2', '日程管理-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-assignment/create', '2', '角色分配-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-assignment/delete', '2', '角色分配-删除数据', 'auth-assignment', null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-assignment/export', '2', '角色分配-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-assignment/index', '2', '角色分配-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-assignment/search', '2', '角色分配-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/create', '2', '规则管理-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/delete', '2', '规则管理-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/delete-all', '2', '规则管理-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/export', '2', '规则管理-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/index', '2', '规则管理-显示数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/search', '2', '规则管理-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('auth-rule/update', '2', '规则管理-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/create', '2', '权限信息-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/delete', '2', '权限信息-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/delete-all', '2', '权限信息-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/export', '2', '权限信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/index', '2', '权限信息-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/search', '2', '权限信息-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('authority/update', '2', '权限信息-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/create', '2', '地址信息-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/delete', '2', '地址信息-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/delete-all', '2', '地址信息-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/export', '2', '地址信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/index', '2', '地址信息-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/search', '2', '地址信息-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('china/update', '2', '地址信息-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/create', '2', '导航栏目-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/delete', '2', '导航栏目-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/delete-all', '2', '导航栏目-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/export', '2', '导航栏目-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/index', '2', '导航栏目-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/search', '2', '导航栏目-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('menu/update', '2', '导航栏目-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('module/create', '2', '模块生成-生成预览表单', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('module/index', '2', '模块生成-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('module/produce', '2', '模块生成-生成文件', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('module/update', '2', '模块生成-生成预览文件', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/create', '2', '角色信息-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/delete', '2', '角色信息-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/edit', '2', '角色信息-分配权限', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/export', '2', '角色信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/index', '2', '角色信息-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/search', '2', '角色信息-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/update', '2', '角色信息-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('role/view', '2', '角色权限-查看详情', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('system-config/create', '2', '添加数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/delete', '2', '删除数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/delete-all', '2', '批量删除-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/export', '2', '导出数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/index', '2', '显示数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/search', '2', '搜索数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('system-config/update', '2', '修改数据-系统配置', null, null, '1531721454', '1531721454');
INSERT INTO `auth_item` VALUES ('uploads/create', '2', '上传文件-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/delete', '2', '上传文件-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/delete-all', '2', '上传文件-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/export', '2', '上传文件-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/index', '2', '上传文件-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/search', '2', '上传文件-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/update', '2', '上传文件-修改数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('uploads/upload', '2', '上传文件-文件上传', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/create', '2', '用户信息-添加数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/delete', '2', '用户信息-删除数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/delete-all', '2', '用户信息-批量删除', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/export', '2', '用户信息-导出数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/index', '2', '用户信息-显示页面', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/search', '2', '用户信息-搜索数据', null, null, '1531475934', '1531475934');
INSERT INTO `auth_item` VALUES ('user/update', '2', '用户信息-修改数据', null, null, '1531475934', '1531475934');
...
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/create');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/delete');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/delete-all');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/export');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/index');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/search');
INSERT INTO `auth_item_child` VALUES ('administrator', 'system-config/update');
...
-- ----------------------------
INSERT INTO `auth_rule` VALUES ('admin', 0x4F3A32333A226261636B656E645C72756C65735C41646D696E52756C65223A333A7B733A343A226E616D65223B733A353A2261646D696E223B733A393A22637265617465644174223B693A313439393030363036393B733A393A22757064617465644174223B693A313439393030363036393B7D, '1531475934', '1531475934');
INSERT INTO `auth_rule` VALUES ('admin-delete', , '1531475934', '1531475934');
...
CREATE TABLE `log` (
  ...
  `description` char(15) DEFAULT '' COMMENT '描述',
...
CREATE TABLE `menu` (
  ...
  `updated_id` int(11) NOT NULL DEFAULT '0' COMMENT '修改用户',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='后台导航栏目信息表';

-- ----------------------------
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES ('1', '0', '后台管理', 'menu-icon fa fa-cog', '', '1', '1', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('2', '1', '管理员信息', '', 'admin/index', '1', '1', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('3', '1', '导航栏目', '', 'menu/index', '1', '2', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('4', '1', '模块生成', '', 'module/index', '1', '3', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('5', '1', '操作日志', '', 'admin-log/index', '1', '4', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('6', '1', '后台权限', '', '', '1', '5', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('7', '6', '角色管理', 'menu-icon fa fa-graduation-cap', 'role/index', '1', '1', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('8', '6', '角色分配', 'menu-icon fa fa-paper-plane', 'auth-assignment/index', '1', '2', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('9', '6', '权限管理', 'menu-icon fa fa-fire', 'authority/index', '1', '3', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('10', '6', '规则管理', 'menu-icon fa fa-shield', 'auth-rule/index', '1', '4', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('11', '0', '地址信息', 'menu-icon fa fa-bank', 'china/index', '1', '2', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('12', '0', '用户信息', 'menu-icon fa fa-user', 'user/index', '1', '3', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('13', '0', '日程管理', 'menu-icon fa fa-calendar', 'arrange/index', '1', '4', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('14', '0', '上传文件', 'menu-icon fa fa-upload', 'uploads/index', '1', '5', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('15', '0', 'API管理', 'menu-icon fa fa-external-link', 'api/index', '1', '6', '1531475870', '1', '1531475870', '1');
INSERT INTO `menu` VALUES ('16', '0', '系统配置', 'menu-icon fa fa-cog', '', '1', '200', '1531720502', '1', '1531720539', '1');
INSERT INTO `menu` VALUES ('17', '16', '系统配置', '', 'system-config/index', '1', '100', '1531720610', '1', '1531720690', '1');
...
-- ----------------------------
INSERT INTO `migration` VALUES ('m000000_000000_base', '1531475863');
INSERT INTO `migration` VALUES ('m130524_201442_init', '1531475870');
INSERT INTO `migration` VALUES ('m140506_102106_rbac_init', '1531475927');
INSERT INTO `migration` VALUES ('m170801_061245_create_menu', '1531475870');
INSERT INTO `migration` VALUES ('m170801_072726_create_admin', '1531475871');
INSERT INTO `migration` VALUES ('m170801_074527_create_arrange', '1531475871');
INSERT INTO `migration` VALUES ('m170801_081237_insert_rabc', '1531475934');
INSERT INTO `migration` VALUES ('m170804_163745_create_china', '1531475934');
INSERT INTO `migration` VALUES ('m170805_100055_create_admin_log', '1531475934');
INSERT INTO `migration` VALUES ('m170907_052038_rbac_add_index_on_auth_assignment_user_id', '1531475927');
INSERT INTO `migration` VALUES ('m171118_082050_create_uploads', '1531475934');
...
CREATE TABLE `product_data` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `type` tinyint(4) DEFAULT NULL COMMENT '同步类型',
  `status` tinyint(4) DEFAULT '2' COMMENT '状态 1新建 2同步中 3失败 4成功',
...
CREATE TABLE `system_config` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `config_key` varchar(255) NOT NULL DEFAULT '' COMMENT '配置名称',
  `config_value` varchar(255) NOT NULL DEFAULT '' COMMENT '配置值',
  `updated_at` int(10) unsigned DEFAULT '0' COMMENT '更新时间',
  `modify_by` int(10) unsigned DEFAULT '0' COMMENT '用户ID',
...
-- ----------------------------
INSERT INTO `system_config` VALUES ('1', 'jingdong/auth_url', 'https://oauth.jd.com/oauth/authorize', '0', '0', '京东授权地址');
INSERT INTO `system_config` VALUES ('2', 'jingdong/app_key', '84FC1EA413556FB66F299EFA075FCCF5', '1531727976', '0', '授权appKey');
INSERT INTO `system_config` VALUES ('3', 'jingdong/auth_redirect_uri', 'http://uapim.com/auth', '0', '0', '授权回调地址');
