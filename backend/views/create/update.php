    ...
    <form class="layui-col-md12 layui-form">
      <div class="layui-card">
        ...
        <div class="layui-card-body layui-row layui-col-space10">
          ...
          <div class="layui-col-md3">
            <input type="text" name="delivery" placeholder="预计交付期" value="<?php echo $order['date'] ?>" autocomplete="off" class="layui-input" id="delivery">
          </div>
          <div class="layui-col-md3">
            <input type="text" name="package" placeholder="包装要求" value="<?php echo $order['package'] ?>" autocomplete="off" class="layui-input">
          </div>
          <div class="layui-col-md3">
            <input type="text" name="contact" placeholder="提货联系人" value="<?php echo $order['name'] ?>" autocomplete="off" class="layui-input">
          </div>
          <div class="layui-col-md12">
            <input type="text" name="address" placeholder="交付地址" value="<?php echo $order['address'] ?>" autocomplete="off" class="layui-input">
          </div>
          <div class="layui-col-md12">
