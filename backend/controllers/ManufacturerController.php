...
class ManufacturerController extends Controller
{
        ...
        if(!$itemId || !$value){
            ...
            if(!$supplierOrderItem){
                ...
                if (!$order || ($supplierOrderItem->quote_status == 1)) {
                    ...
                    // 采购商折扣价
                    $disc_rate = (float) ($user->discount / 100);
                    $disc_rate = (1 - $disc_rate);
                    $disc_price = $value * $disc_rate;
                    ...
                    $orderItem->setAttribute('disc_price', ($disc_price == 0) ? $value : $disc_price);
                    $orderItem->save();
                    $data = [
                        'code' => 200,
                    ];
    ...
    public function actionProducts()
    {
        ...
        $model = $this->handleSupOrderItem($orderId, $model);
